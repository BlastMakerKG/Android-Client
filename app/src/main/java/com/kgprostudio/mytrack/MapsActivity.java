        ...
        record_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lastLocation == null) {
                    Toast.makeText(MapsActivity.this, "Требуется определение местоположения", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MapsActivity.this, "Запись данных  началась...", Toast.LENGTH_SHORT).show();
